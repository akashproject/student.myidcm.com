			...
			<div class="card-body">
				...
				<div class="card">
					...
					<ul class="nav nav-tabs" role="tablist">
						...
						<li class="nav-item"> 
							<a class="nav-link" data-toggle="tab" href="#contact" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down">Contact Settings</span></a>
						</li>
						<li class="nav-item"> 
							<a class="nav-link" data-toggle="tab" href="#social" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down">Social Settings</span></a>
						</li>
						<li class="nav-item"> 
							<a class="nav-link" data-toggle="tab" href="#utm" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down">UTM Settings</span></a> 
						</li>
						<li class="nav-item"> 
							<a class="nav-link" data-toggle="tab" href="#schema" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down">Default Schema</span></a>
						</li>
					</ul>
								...
								<div class="row">
									<div class="col-md-7" >
										...
										<div class="form-group row">
											...
											<div class="col-sm-9">
												<textarea class="form-control" name="footer_about" id="footer_about" placeholder="Enter footer about Here" >{{ isset($settings['footer_about'])?$settings['footer_about']:'' }}</textarea>
											</div>
